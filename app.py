...
<style>
    ...
    .logo-image {
        max-width: 80%; /* Ajuste o tamanho máximo da imagem */
        height: auto;
    }
    ...
    .stButton button {
        ...
        background-color: #1a237e; /* Cor do botão para combinar com o tema */
        border: 2px solid #1a237e;
        border-radius: 10px;
        box-shadow: 0 4px 8px rgba(0,0,0,0.1);
        padding: 1rem 3rem; /* Aumenta o preenchimento do botão */
        transition: 0.3s;
    }
...
# Lógica para a navegação de páginas
if 'page' not in st.session_state:
    st.session_state.page = 'home'

def go_to_main_page():
    """Função para mudar para a página principal do app."""
...
if st.session_state.page == 'home':
    ...
    with col2:
        st.button("Entrar", on_click=go_to_main_page)

elif st.session_state.page == 'main_app':
    # --- Estrutura do App Streamlit Original ---
    # Coloque aqui todo o código do seu aplicativo original
    # (a partir de 'Carrega e rotaciona as imagens' para baixo)
