...
# --- CSS DE ALTA PRECISÃO (Toolbar em linha única) ---
st.markdown("""
<style>
    ...
    /* Redução de Gaps para "colar" os elementos */
    .block-container { padding-top: 1.5rem !important; }
    [data-testid="stVerticalBlock"] { gap: 0.3rem !important; }

    /* FORÇAR TUDO NA MESMA LINHA (Até 4 colunas no mobile) */
    ...
    /* Estilo dos Botões (Ultra Compactos) */
    div.stButton > button {
        width: 100% !important;
        border-radius: 6px !important;
        height: 38px !important; /* Altura reduzida para caber 4 na linha */
        font-weight: 600 !important;
        font-size: 0.65rem !important; /* Fonte menor para não quebrar texto */
    ...
    /* Botão de Navegação (Anterior/Próximo) colado na foto */
...
if st.session_state.page == 'home':
    ...
    st.markdown('<div style="text-align:center; font-weight:700; color:#1a237e; margin-bottom:20px;">IDENTIFIQUE-SE</div>', unsafe_allow_html=True)
    ...
    st.markdown(f'<div style="text-align:center; color:#333; font-weight:700; font-size:0.8rem; margin-bottom:-5px;">{name_map[current_user]}</div>', unsafe_allow_html=True)
    ...
    # --- BARRA DE FERRAMENTAS (TOOLBAR) ÚNICA ---
    # Usamos 4 colunas para que tudo caiba na mesma linha
